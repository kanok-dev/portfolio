...
| **Architecture** | ✅ **SaaS-Ready** - Offline-oriented field operations with API sync patterns |
| **State Management** | MobX / MobX State Tree with AsyncStorage persistence |
| **Features** | Camera capture, GPS tracking, schedule visits, price checks, surveys, stock take, POSM, promotion checks |
...
- **React Native Tab View** (^4.2.2) - Swipeable tab views with smooth animations
